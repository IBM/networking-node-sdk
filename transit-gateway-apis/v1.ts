 ...
 */
 ...
 class TransitGatewayApisV1 extends BaseService {
    ...
    * network_type 'classic' connection. This field must specify the ID of an active transit gateway network_type
    * 'classic' connection in the same transit gateway.
    *
    ...
    * unavailable 64512-64513, 65100, 65201-65234, 65402-65433, 65500 and 4201065000-4201065999. If 'remote_bgp_asn' is
 ...
 namespace TransitGatewayApisV1 {
   ...
   export interface CreateTransitGatewayConnectionParams {
      ...
      *  This field must specify the ID of an active transit gateway network_type 'classic' connection in the same
      *  transit gateway.
      *
      *  This field is required for network type 'gre_tunnel' connections.
      *
     ...
     /** Remote network BGP ASN. The following ASN values are reserved and unavailable 64512-64513, 65100,
      *  65201-65234, 65402-65433, 65500 and 4201065000-4201065999. If 'remote_bgp_asn' is omitted on gre_tunnel or
